...
ax.grid()
plt.show()
plt.savefig('/home/oba/programs/Fourier/fourier_result/test_1.png')
...
plt.show()
plt.savefig('/home/oba/programs/Fourier/fourier_result/test_2.png')
...
ax.grid()
plt.show()
plt.savefig('/home/oba/programs/Fourier/fourier_result/test_3.png')
