...
#    plt.savefig(f"/home/oba/programs/Fourier/main_result/testf{i+1}_2.png")
    plt.savefig(f"/home/oba/programs/Fourier/ez_main/p{i+1}.png")
    plt.show()
    plt.clf()
    probe.extend([source])
...
plt.savefig("/home/oba/programs/Fourier/ez_main/pnum.png")
plt.show()
plt.clf()
...
plt.savefig("/home/oba/programs/Fourier/ez_main/test1.png")
...
plt.savefig("/home/oba/programs/Fourier/ez_main/test2.png")
plt.clf()
...
plt.show()
plt.savefig("/home/oba/programs/Fourier/ez_main/testsum_probe_fft3.png")'''
