...
np.random.seed(100)
path_name = "make_new_model_5"
#---------------------------------------------------------------
N = 100
mus_sv = np.array([30, 30, 30])
taus_sv = np.array([30., 10., 0.5])
pi = np.array([0.27, 0.41, 0.32])
K_true = len(mus_sv)

ss = np.random.choice(K_true, size=100, replace=True, p=pi)
x1 = np.random.randn(N) * 1.0/np.sqrt(taus_sv[ss]) + mus_sv[ss]

fig = plt.figure(figsize=(8, 3))
ax = fig.subplots(1,1)
sns.distplot(x1, bins=50, ax=ax)
plt.savefig('/home/oba/programs/bayes/make_new_model_result/' + path_name +'_1.png')
...
x = np.random.randn(N1) * 1.0/np.sqrt(taus_sv[ss]) + mus_sv[ss]

fig = plt.figure(figsize=(8, 3))
ax = fig.subplots(1,1)
sns.distplot(x, bins=50, ax=ax)
plt.savefig('/home/oba/programs/bayes/make_new_model_result/' + path_name +'_2.png')
...
plt.savefig('/home/oba/programs/bayes/make_new_model_result/' + path_name +'_3.png')
...
ax[0].legend()
ax[1].legend()
plt.savefig('/home/oba/programs/bayes/make_new_model_result/' + path_name +'_4.png')
...
ax.legend()
plt.savefig('/home/oba/programs/bayes/make_new_model_result/' + path_name +'_5.png')
...
plt.savefig('/home/oba/programs/bayes/make_new_model_result/' + path_name +'_6.png')
for i in range(5):
    ax.plot(x_plot, post_components[i,:], '--', c=colors[i], label=f'comp{i}')
    ax.legend()
plt.savefig('/home/oba/programs/bayes/make_new_model_result/' + path_name +'_7.png')